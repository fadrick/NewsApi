...
public class DawnAdapter extends RecyclerView.Adapter<DawnAdapter.ViewHolder> {
    ...
    public DawnAdapter(Context context, ArrayList<String> title, ArrayList<String> desc,ArrayList<Integer> images) {
